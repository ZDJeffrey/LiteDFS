...
class NameNode(n_pb2_grpc.NameNodeServicer):
    def __init__(self) -> None:
        ...
        self.data_nodes = {}        # 数据节点id:(ip:port)
    ...
    def touch(self, request, context):
        ...
        if len(path_list)==0:
            return n_pb2.RmResponse(type=n_pb2.RmResponseType.Value('TOUCH_INVALID'))
    ...
    def closeWrite(self, request, context):
        ...
        with file.mtx:
            ...
            return n_pb2.CloseWriteResponse(type=n_pb2.CloseResponseType.Value('CLOSE_SUCCESS'), ts=file.ts)
